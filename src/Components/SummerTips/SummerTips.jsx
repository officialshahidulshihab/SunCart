    ...
    return (
        <div>
            <div className='space-y-2 text-center mb-4'>
                <h1 className='text-4xl font-bold'>Summer Care <span className='bg-linear-to-r from-orange-500 to-pink-500 text-transparent bg-clip-text '>Tips</span></h1>
            <p className='text-gray-600'>Essential tips to keep you safe and glowing all summer long</p>
            </div>
            <div className='grid grid-cols-4 gap-5 mt-6 mb-6'>
                <div className='space-y-2 bg-orange-50 shadow-sm p-4 rounded-xl' >
                    ...
                    <p className='text-gray-600'>Always wear SPF 50+ sunscreen. Reapply every 2 hours for maximum protection.</p>
                </div>
                <div className='space-y-2 bg-orange-50  shadow-sm p-4 rounded-xl' >
                    ...
                    <p className='text-gray-600'>Drink at least 8 glasses of water daily. Add electrolytes for outdoor activities.</p>
                </div>
                <div className='space-y-2 bg-orange-50  shadow-sm p-4 rounded-xl' >
                    ...
                    <p className='text-gray-600'>Stay in shade between 10 AM - 4 PM when UV rays are strongest.</p>
                </div>
                <div className='space-y-2 bg-orange-50  shadow-sm p-4 rounded-xl' >
                    ...
                    <p className='text-gray-600'>Use after-sun lotion to soothe and moisturize your skin daily.</p>
                </div>
