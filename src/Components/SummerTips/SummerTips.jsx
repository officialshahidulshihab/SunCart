...
const SummerTips = () => {
    return (
        <div>
            ...
            <p className='text-gray-600 text-center w-70 lg:w-330'>Essential tips to keep you safe and glowing all summer long</p>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 gap-5 mt-6 mb-6'>
                <div className='space-y-2 w-90 lg:w-75 bg-orange-50 shadow-sm p-4 rounded-xl' >
                    ...
                    <p className='text-gray-600 w-70 lg:w-70'>Always wear SPF 50+ sunscreen. Reapply every 2 hours for maximum protection.</p>
                </div>
                <div className='space-y-2 w-90 lg:w-75 bg-orange-50  shadow-sm p-4 rounded-xl' >
                    ...
                    <p className='text-gray-600 w-70 lg:w-65'>Drink at least 8 glasses of water daily. Add electrolytes for outdoor activities.</p>
                </div>
                <div className='space-y-2 w-90 lg:w-75 bg-orange-50  shadow-sm p-4 rounded-xl' >
                    ...
                    <p className='text-gray-600 w-70 lg:w-75'>Stay in shade between 10 AM - 4 PM when UV rays are strongest.</p>
                </div>
                <div className='space-y-2  w-90 lg:w-75  bg-orange-50  shadow-sm p-4 rounded-xl' >
                    ...
                    <p className='text-gray-600 w-70 lg:w-75'>Use after-sun lotion to soothe and moisturize your skin daily.</p>
                </div>
