      ...
      <div>
        <div className="space-y-3">
          ...
          <div className="flex gap-5 items-center mt-6 mb-6">
            <Link href={"/products"}>
            <button className="px-5 py-2.5 cursor-pointer rounded-lg bg-linear-to-r from-orange-500 to-pink-500 font-bold flex items-center gap-2 text-white text-xl">
              <span>Shop Now</span>
              <FaArrowRightLong />
            </button></Link>
